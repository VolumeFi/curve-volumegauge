...
def add_liquidity(uamounts: uint256[N_COINS], min_mint_amount: uint256):
    raw_call(self.base, concat(method_id("add_liquidity(uint256[N_COINS],uint256)"), convert(uamounts, Bytes[4 * N_COINS]), convert(min_mint_amount, Bytes[4])))
    # raw_call(self.base, 0xa9059cbb)
